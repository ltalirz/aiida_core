...
def load_config(create=False):
    ...
    Warning: Contrary to :py:func:`get_config`, this function is uncached and will always create a new Config object.
    In most cases, you will want to call :py:func:`get_config` instead.
...
def get_config(create=False):
     ...
     * the configuration is loaded using :py:func:`load_conf`
