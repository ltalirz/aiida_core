...
from aiida.common import json, utils
    ...
    def test_full_backup_setup_script(self):
        ...
        try:
            ...
            with io.open(os.path.join(temp_aiida_folder, 'backup_info.json'), encoding='utf8') as conf_jfile:
                ...
                self.assertEqual(conf_cont[AbstractBackup.END_DATE_OF_BACKUP_KEY], '2015-04-11 13:55:53.688484+00:00')
                self.assertEqual(conf_cont[AbstractBackup.PERIODICITY_KEY], 1)
                self.assertEqual(conf_cont[AbstractBackup.BACKUP_LENGTH_THRESHOLD_KEY], 2)
        finally:
