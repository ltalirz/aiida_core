...
from aiida.tools.importexport.dbexport.utils import (
    check_licenses, fill_in_query, serialize_dict, check_process_nodes_sealed, retrieve_linked_nodes, print_header
)
...
def export_tree(
    ...
    **kwargs
    ...
    if not silent:
        ...
        progress_bar.set_description_str('Catalogu nodes ...')
    ...
    to_be_exported, links_uuid, graph_traversal_rules = retrieve_linked_nodes(
        given_calculation_entry_ids, given_data_entry_ids, silent=silent, **kwargs
    )
